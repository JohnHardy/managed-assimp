...
{
    /**
     * <summary>Lists all provided post processing steps.</summary>
     * 
    ...
    {
	    /**
	     * <summary>Declares some handy post processing presets.</summary>
	     * @author Alexander Gessler (aramis_acg@users.sourceforge.net)
	     */
        public abstract class Preset
        {
            /**
             * <summary>Simple set of flags which handle DirectX transformations. </summary>
             */
		    ...
		    /**
		     * <summary>Simple post processing preset targeting fast loading for use in real time apps.</summary>
		     * 
        ...
        /**
         * <summary>Calculates the tangents and bitangents (aka 'binormals') for the imported meshes.</summary>
         * 
        ...
        /**
         * <summary>Identifies and joins identical vertex data sets within all imported
         * meshes.</summary>
         * 
        ...
        /**
         * <summary>Converts all the imported data to a left-handed coordinate space.
         * 
        ...
        /**
         * <summary>Triangulates all faces.
         * 
         ...
         * other kinds of primitives, try the following:</summary>
         * <ul>
        ...
        /**
         * <summary>Removes some parts of the data structure (animations, materials, light
         * sources, cameras, textures, specific vertex components, ..).</summary>
         * 
        ...
        /**
         * <summary>Generates per-face normals for all meshes in the scene.
         * 
        ...
        /**
         * <summary>Generates smooth per-vertex normals for all meshes in the scene.
         * 
         * This step is skipped if normals are already present in the source file.
         * Model importers try to load them from the source file and many file
         * formats provide support for them.</summary>
         * 
        ...
        /**
         * <summary>Splits large unbeatable meshes into smaller sub meshes.
         * 
         ...
         * specify both a triangle and vertex limit for a single mesh.</summary>
         * 
        ...
        /**
         * <summary>Removes the node graph and transforms all vertices by the absolute
         ...
         * a scene graph-like system.</summary>
         */
        public static uint PreTransformVertices = 0x100;

        /**
         * <summary>Limits the number of bones simultaneously affecting a single vertex to a
        ...
        /**
         * <summary>Validates the imported scene data structure .This makes sure that all
         * indices are valid, all animations and bones are linked correctly, all
         * material references are correct .. etc.</summary>
         * 
        ...
        /**
         * <summary>Reorders triangles for better vertex cache locality.</summary>
         * 
        ...
        /**
         * <summary>Searches for redundant/unreferenced materials and removes them.</summary>
         * 
        ...
        /**
         * <summary>This step tries to determine which meshes have normal vectors that are
         ...
         * not always correct.</summary>
         */
        public static uint FixInfacingNormals = 0x2000;

        /**
         * <summary>This step splits meshes with more than one primitive type in homogeneous
         * sub meshes.</summary>
         * 
        ...
        /**
         * <summary>This step searches all meshes for degenerated primitives and converts
         * them to proper lines or points.</summary>
         * 
        ...
        /**
         * <summary>This step searches all meshes for incorrect data such as all-zero normal
         * vectors or invalid UV coordinates and removes them.</summary>
         * 
        ...
        /**
         * <summary>This step converts non-UV mappings (such as spherical or cylindrical
         * mapping) to proper texture coordinate channels.</summary>
         * 
         ...
         *       <tt>#AI_MATKEY_MAPPING<tt> material property in order to display
         *        all files properly.
         */
        public static uint GenUVCoords = 0x40000;

        /**
         * <summary>This step applies per-texture UV transformations and bakes them to
         * stand-alone texture coordinate channels.</summary>
         * 
        ...
        /**
         * <summary>This step searches for duplicate meshes and replaces duplicates with
         * references to the first mesh.</summary>
         * 
        ...
        /**
         * <summary>A post processing step to reduce the number of meshes in the scene. 
         ...
         * <code>SortByPType</code>.</summary>
         */
        public static uint OptimizeMeshes = 0x200000;

        /**
         * <summary> Nodes with no animations, bones, lights or cameras assigned are collapsed
         * and joined.</summary>
         * 
        ...
        /**
         * <summary>This step flips all UV coordinates along the y-axis and adjusts material
         * settings and bitangents accordingly.</summary> <br>
        ...
        /**
         * <summary>This step adjusts the output face winding order to be clockwise.</summary>
         * 
