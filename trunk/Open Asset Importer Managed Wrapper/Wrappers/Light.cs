...
namespace Assimp.ManagedAssimp
{
    ...
    /**
     * <summary>Enumerates all supported types of light sources in a scene.</summary>
     */
    public enum LightType : int
    {
        /** <summary>Undefined light type.</summary> */
		UNDEFINED = 0x0,

        /** <summary> A directional light source has a well-defined direction but is
         * infinitely far away. That's quite a good approximation for sun light.</summary> */
        DIRECTIONAL = 0x1,

        /**<summary> A point light source has a well-defined position in space but no
         * direction - it emmits light in all directions. A normal bulb is a
         * point light.</summary> */
        POINT = 0x2,

        /**<summary> A spot light source emmits light in a specific angle. It has a
         * position and a direction it is pointing to. A good example for a spot
         * light is a light spot in sport arenas.</summary> */
		SPOT = 0x3,
	}

    /**
     * <summary>Describes a virtual light source in the scene.  Lights have a representation in the node graph and can be animated.</summary>
    ...
    public class Light
    {
        ...
        /**
         * <summary>Constructor which builds a Light object from a pointer to an aiLight structure.  As a user, you should not call this by hand.</summary>
         * <remarks>This will copy the data inside the structure into managed memory.  It *DOES NOT* free the unmanaged memory.</remarks>
         * @param aiLight* A pointer to the face structure in the low level unmanaged wrapper.
         */
	    ...
	    /**
	     * <summary>Get the name of the light source.</summary>
	     * 
	    ...
	    /**
	     * <summary>Get the type of the light source.</summary>
         * @return The enumerate light type.
	     */
        ...
        /**
         * <summary>Get the position of the light source in space. Relative to the
         * transformation of the node corresponding to the light.</summary>
         * 
         * The position is undefined for directional lights.
         * 
         * @return aiVector3D with x,y,z values.
         */
        ...
        /**
         * <summary>Get the direction of the light source in space. Relative to the
         * transformation of the node corresponding to the light.</summary>
         * 
	    ...
	    /**
	     * <summary>Get the constant light attenuation factor.</summary>
	     * 
	    ...
	    /**
	     * <summary>Get the linear light attenuation factor.</summary>
	     * 
	     * The intensity of the light source at a given distance 'd' from the
	     * light's position is
	     * 
	    ...
	    /**
	     * <summary>Get the quadratic light attenuation factor.</summary>
	     * 
	     * The intensity of the light source at a given distance 'd' from the
	     * light's position is
	     * 
	    ...
	    /**
	     * <summary>Get the diffuse color of the light source.</summary>
	     */
	    ...
	    /**
	     * <summary>Get the specular color of the light source.</summary>
	     * 
	    ...
	    /**
	     * <summary>Get the ambient color of the light source.</summary>
	     * 
	    ...
	    /**
	     * <summary>Get the inner angle of a spot light's light cone.</summary>
	     * 
	    ...
	    /**
	     * <summary>Get the outer angle of a spot light's light cone.</summary>
	     * 
