...
namespace Assimp.ManagedAssimp
{
    ...
    /**
     * <summary>Class to wrap materials. Materials are represented in ASSIMP as a list of key/value pairs, the key being a <code>String</code> and the value being a binary buffer. The class provides several get methods to access material properties easily.</summary>
    ...
    public class Material
    {
        #region Constants
        /**
         * <summary>This awesome little class binds a type to a property name.</summary>
         * @thanks for the great idea Alexander Gessler in jAssimp!
         */
        public class PropertyBinding<T>
        {
            /** <summary>Name of the property.</summary> */
            internal String sName               = "";
            /** <summary>The texture type of the property.  Only useful for texture properies.</summary> */
            internal TextureType eTextureType   = 0;
            /** <summary>The texture index of the property.  Only useful for texture properies.</summary> */
            internal uint iTextureIndex         = 0;

            /**
             * <summary>Construct a new class which stores information about a property.</summary>
            ...
            /**
             * <summary>Get the name of this property.  This corrsponds to the property "key" in a material.</summary>.
             */
            ...
            /**
             * <summary>Return the texture type of the property.  This specifies the exact usage semantic.  For non-texture properties, this member is always 0 or aiTextureType_NONE.</summary>
            ...
            /**
             * <summary>Return the texture index. For non-texture properties, this member is always 0.</summary>
             */
        ...
        */
        ...
        /** <summary>The string where we can find the texture file ascociated with this material. </summary> */
        ...
        #region Enumerations
        /**
         * <summary>This defines the enumerated values for the type properties asociated with a MaterialProperty.</summary>
         */
        ...
        /** 
         * <summary>Defines how the Nth texture of a specific type is combined with
         *  the result of all previous layers.</summary>
         *
        ...
        /** 
         * <summary>Defines the purpose of a texture.  Related to MaterialProperty.getSemantic().
         ...
         *  as closely as possible.</summary>
         *  
        ...
        {
            /**
             * <summary>Dummy value. No texture, but the value to be used as 'texture semantic' 
             *  <code>MaterialProperty.getSemantic()</code> for all material properties *not* related to textures.
             */
            NONE = 0x0,

            /**
             * <summary>The texture is combined with the result of the diffuse lighting equation.</summary>
             */
            DIFFUSE = 0x1,

            /** 
             * <summary>The texture is combined with the result of the specular lighting equation.</summary>
             */
            SPECULAR = 0x2,

            /**
             * <summary>The texture is combined with the result of the ambient lighting equation.</summary>
             */
            AMBIENT = 0x3,

            /**
             * <summary>The texture is added to the result of the lighting calculation. It isn't influenced by incoming light.</summary>
             */
            EMISSIVE = 0x4,

            /**
             * <summary>The texture is a height map.
             * By convention, higher grey-scale values stand for higher elevations from the base height.</summary>
             */
            HEIGHT = 0x5,

            /**
             * <summary>The texture is a (tangent space) normal-map.
             * Again, there are several conventions for tangent-space normal maps. Assimp does (intentionally) not differenciate here.</summary>
             */
            NORMALS = 0x6,

            /**
             * <summary>The texture defines the glossiness of the material. 
             * The glossiness is in fact the exponent of the specular (phong) lighting equation. Usually there is a conversion function defined to map the linear color values in the texture to a suitable exponent. Have fun.</summary>
             */
            SHININESS = 0x7,

            /**
             * <summary>The texture defines per-pixel opacity. Usually 'white' means opaque and 'black' means 'transparency'. Or quite the opposite. Have fun.</summary>
             */
            OPACITY = 0x8,

            /** 
             * <summary>Displacement texture.
             * The exact purpose and format is application-dependent. Higher color values stand for higher vertex displacements.</summary>
             */
            DISPLACEMENT = 0x9,
             ...
             * scaling value for the final color value of a pixel. It's intensity is not affected by incoming light.</summary>
             */
            LIGHTMAP = 0xA,

            /**
             * <summary>Reflection texture. Contains the color of a perfect mirror reflection. Rarely used, almost nevery for real-time applications.</summary>
            */
            REFLECTION = 0xB,

            /** 
             * <summary>Unknown texture. A texture reference that does not match any of the definitions above is considered to be 'unknown'. It is still imported, but is excluded from any further postprocessing.</summary>
             */
            UNKNOWN = 0xC,
        }
        ...
        public enum ShadingMode : uint
        {
             ...
             *  diffuse only. Also known as 'faceted shading'.</summary>
             */
            Flat = 0x1,
             ...
             *  Also known as 'comic' shader.</summary>
             */
            Toon = 0x5,

            /**
             * <summary>OrenNayar-Shading per pixel. Extension to standard Lambertian shading, taking the
             * roughness of the material into account.</summary>
             */
            OrenNayar = 0x6,

            /**
             * <summary>Minnaert-Shading per pixel.  Extension to standard Lambertian shading, taking the "darkness" of the material into account</summary>
             */
            Minnaert = 0x7,

            /**
             * <summary>CookTorrance-Shading per pixel
             *  Special shader for metallic surfaces.</summary>
             */
            CookTorrance = 0x8,

            /**
             * <summary>No shading at all. Constant light influence of 1.0.</summary>
             */
            NoShading = 0x9,
        ...
        /** 
         * <summary>Defines some mixed flags for a particular texture.  This corresponds to the #AI_MATKEY_TEXFLAGS property.</summary>
        ...
        {
            /** <summary>The texture's color values have to be inverted (componentwise 1-n)</summary> */
            Invert = 0x1,

            /**
             * <summary>Explicit request to the application to process the alpha channel of the texture.</summary>
             *
            ...
            /**
             * <summary>Explicit request to the application to ignore the alpha channel of the texture.  Mutually exclusive with #aiTextureFlags_IgnoreAlpha.</summary>
             */
            IgnoreAlpha = 0x4,
        }

        /** 
         * <summary>Defines alpha-blend flags.  This corresponds to the #AI_MATKEY_BLEND_FUNC property.</summary>
         *
        ...
        {
            /** 
             * <summary>Default blending. SourceColor*SourceAlpha + DestColor*(1-SourceAlpha)</summary>
             */
            Default = 0x0,

            /**
             * <summary>Additive blending.  SourceColor*1 + DestColor*1</summary>
             */
            Additive = 0x1,
        ...
        #region Properties
        /** <summary>Table of properties loaded.  This is built from a "MaterialProperty** mProperties" double pointer to MaterialProperty.</summary> */
        ...
        /**
         * <summary>Constructor which builds a Material object from a pointer to an aiMaterial structure.  As a user, you should not call this by hand.</summary>
         * <remarks>This will copy the data inside the structure into managed memory.  It *DOES NOT* free the unmanaged memory.</remarks>
         * @param aiMaterial* A pointer to the face structure in the low level unmanaged wrapper.
         */
        ...
        /**
         * <summary>Get the number of properties that this material has.</summary>
         * @return An integer which contains the number of properties we have.
         */
        ...
        /**
         * <summary>Get the string array of property keys which this material has.
         * @return An array of strings which is all the keys in our material property table.
         */
        ...
        /**
         * <summary>Read a property from this material as an 'object'.</summary>
         * @param sKey The property key to read as a string.
         * @return The "object" which contains the data.  You will have to cast by hand.  Null if not found.
         */
        ...
        /**
         * <summary>Read a property from this material as a reference to the "MaterialProperty" class.</summary>
         * This returns a MaterialProperty which you should never really need to access to be honest.
         * Use the constants or byte array.
         * @param sKey The property key to read as a string.
         * @return The MaterialProperty object which contains our property.  Null if not found.
         */
        ...
        /**
         * <summary>Read the internal data of the property at this key and attempt to marshall it into a string.
         * This returns a String and as marshalls it a strange way and as such is REALLY REALLY unsafe.</summary>
         * @param sKey The property key to read as a string.
         * @return The String which contains our data.
         */
        ...
        /**
         * <summary>Read a property from the material and return its data a a typed structure.
         ...
         * Not reccomended for use.</summary>
         * @return A structure which contains the data in the byte array.
         */
        ...
        /**
         * <summary>Get the byte array value for a specific key from the material.</summary>
         * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param tValue[] The value we want to place our data in.
        ...
        /**
         * <summary>Get the floating-point array value for a specific key from the material.</summary>
         * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param tValue[] The value we want to place our data in.
         * @return True if the property exists, false if not.
         */
        ...
        /**
         * <summary>Get the integer array value for a specific key from the material.</summary>
         * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param tValue[] The value we want to place our data in.
         * @return True if the property exists, false if not.
         */
        ...
        /**
	     * <summary>Get the floating-point value for a specific key from the material.</summary>
	     * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param fValue The value we want to place our data in.
	     * @return True if the property exists, false if not.
	     */
	    ...
	    /**
	     * <summary>Get the 32 bit integer value for a specific key from the material.</summary>
	     * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param iValue The value we want to place our data in.
	     * @return True if the property exists, false if not.
	     */
        ...
        /**
	     * <summary>Get the string value for a specific key from the material.</summary>
	     * @param kKey One of the constant key values like Material.BLEND_FUNC.
         * @param sValue The value we want to place our data in.
	     * @return True if the property exists, false if not.
	     */
